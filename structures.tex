...
We follow on the section \ref{ss:rmq-def} and define operations on the bit string $S$ parametrized by the function $g$ which is to be applied.
\begin{description}
...
The indexed dictionary uses $O(\frac{N}{B} \log B)$ bits and it supports \rank{} on the minima in constant time.
