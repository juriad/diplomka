...
The extra property which the components satisfy is: ``let $C$ be a sequence of components to which the children of a root of a component belong, then each component occurs in at most one run in $C$''.
...
Sometime it is crucial to account every vertex of the original tree once; we do so by introducing a relation \emph{to belong to}.
...
Note that although there can exist a micro-tree having a single vertex, which is its root, it is never shared with other micro-trees and therefore it belongs to it.
The term the \emph{first vertex} is therefore well defined.
...
\begin{description}
	...
	\begin{description}
		...
		The index of $\tau_2$ within the compressed array of the children for the primary micro-tree.
		
		\item[$\childrenParentII$]
		The index of $\tau_2$ within the compressed array of the children for the parent's micro-tree.
...
\begin{description}
	...
	\begin{description}
		...
		\item[$\childrenIndexI$]
		The index of $\tau_1$ within the compressed array of the children for the primary mini-tree.
		
		\item[$\childrenParentI$]
		The index of $\tau_2$ within the compressed array of the children for the parent's mini-tree.
