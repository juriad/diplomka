...
If values present, we could move them to an external table which is indexed by the number of the vertex to which it belongs.
...
\begin{table}
	...
	\begin{tabularx}{\textwidth}{|L{0.7}|J{1.3}|}
		...
		\begin{iteminline}
			\item the level (or its range) of the tree in which we are interested,
...
Supporting the operations \childRank{}, \childSelect{} and \degree{} is preferred over the relative operations \childPrev{}, \childNext{}, \childFirst{} and \childLast{}.
...
The vertex \loRank{} and \loSelect{} are simply $\rank_1(S, i)$ and $\select_1(S, r)$.
