...
\def\openingParen{\relax\ifmmode\textrm{'('}\else'('\fi}
\def\closingParen{\relax\ifmmode\textrm{')'}\else')'\fi}

\usepackage{xifthen}
\newcommand{\defineName}[2][]{%
	\expandafter\def\csname \if\relax\detokenize{#1}\relax#2\else#1\fi\endcsname{\relax\ifmmode\mathit{#2}\else\textsc{#2}\fi}%
}
